...
async def test_get_sensor_list_no_args():
    ...
    with aioresponses() as m:
        ...
        expected_sensor_result = {'2A000001': {'description': 'Dining Room', 'sensor_type': 'S-11', 'site_name': 'MySite'}, 
                                  ...
                                  '2A001001': {'description': 'Dining Room', 'sensor_type': 'S-11', 'site_name': 'MySite'}, 
                                  '2A001002': {'description': 'Basement', 'sensor_type': 'S-11', 'site_name': 'MySite'}, 
                                  '2A001003': {'description': 'Gateway', 'sensor_type': 'S-11', 'site_name': 'MySite'}, 
                                  '2A001004': {'description': 'Kitchen', 'sensor_type': 'S-11', 'site_name': 'MySite'}, 
                                  '2A001005': {'description': 'Laundry Room', 'sensor_type': 'S-11', 'site_name': 'MySite'}
                                }
...
async def test_get_sensor_list_pass_site_id_list():
    ...
    with aioresponses() as m:
        ...
        site_ids = await omnisense.get_site_list()
        site_id_list = list(site_ids.keys())

        sensor_result = await omnisense.get_site_sensor_list(site_id_list)
